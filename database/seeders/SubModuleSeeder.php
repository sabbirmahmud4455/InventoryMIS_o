...
class SubModuleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('sub_modules')->insert([
            ...
            [
                'id' => 27,
                'name_en' => 'Customer Return List',
                'name_bn' => 'ক্রেতা রিটার্ন তালিকা',
                'key' => 'customer_return_list',
                'position' => 2,
                'route' => 'report.index',
                'module_id' => 12,
                'created_at' => $date,
            ...
            [
                'id' => 28,
                'name_en' => 'Supplier Return List',
                'name_bn' => 'মহাজন রিটার্ন তালিকা',
                'key' => 'supplier_return_list',
                'position' => 3,
                'route' => 'report.index',
                'module_id' => 12,
                'created_at' => $date,
