        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="{{ route('sale.report.invoice.export.pdf', ['id' => encrypt($sale_details['sale'][0]->id)]) }}" target="_blank" class="btn btn-sm btn-info float-right">{{ __("Application.Download") }}</a>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
