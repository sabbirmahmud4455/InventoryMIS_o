...
<div class="modal-body">
    <table class="table table-sm table-bordered">
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3">{{ $transaction_details['transactions']->transaction_remarks ? $transaction_details->transaction_remarks : 'N/A' }}</td>
            </tr>
    ...
    @empty($transaction_details['purchase_details'])
        {{-- Purchase Details --}}
