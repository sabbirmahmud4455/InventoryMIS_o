...
<div class="modal-body">
    <form class="ajax-form" method="post" action="{{ route('unit.edit',$unit->id) }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12 form-group">
                <label for="name">{{ __('Unit.Name') }}</label><span class="require-span">*</span>
            ...
            <div class="col-md-12 col-12 form-group">
                ...
                <select class="form-control select2" name="is_active">
                        <option value="1" @if( $unit->is_active == true ) selected @endif>{{ __('Application.Active') }}</option>
                        <option value="0" @if( $unit->is_active == false ) selected @endif>{{ __('Application.Inactive') }}</option>
                </select>
            </div>
