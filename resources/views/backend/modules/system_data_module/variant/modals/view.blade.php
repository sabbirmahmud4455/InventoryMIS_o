<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"> {{ $variant->name }}, {{ __('Application.Information') }} </h5>
            ...
            <table class="table table-bordered table-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $variant->created_at->toDayDateTimeString() }}</td>
                    </tr>

                    <tr>
                        <td>{{ __('Application.LastUpdate') }}</td>
                        <td>{{ $variant->updated_at->toDayDateTimeString() }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
