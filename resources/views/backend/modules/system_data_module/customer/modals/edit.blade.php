<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">{{ __('Customer.Customer')  }} {{ __('Application.Edit') }}</h5>
...
<div class="modal-body">
    <form class="ajax-form" method="post" action="{{ route('customer.update', $customer->id) }}">
        @csrf
        ...
        <div class="row">
           ...
           <div class="col-md-6 col-12 form-group">
            ...
            <div class="col-md-6 col-12 form-group">
                ...
                <input id="phone" type="text" class="form-control" name="phone"  value="{{ $customer->contact_no }}">
            </div>
            ...
            <div class="col-12 form-group">
                ...
                <textarea class="form-control" name="remarks" id="Remarks" cols="30" rows="2">{{ $customer->remarks }}</textarea>
            </div>
